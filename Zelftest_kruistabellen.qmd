...
#| exercise: ex1
#| check: true
answer <- kruistabel.kolom(penguins$species, penguins$island)
...
**= JUIST! De kans om op Biscoe eiland een Gentoo pinguïn te observeren bedraagt bijna 74%. Dit is bijna 3 keer zo groot dat de kans om op datzelfde eiland een Adelie pinguïn te observeren (die kans is afgerond 26%). De verhouding van 74 tov 26 is `{r} round(74/26,2)` wat afgerond 3 benadert.**
...
Mijntabel_oef6b <- table(penguins$sex, penguins$species)

chi.kwadraat.test(Mijntabel_oef6b)

Mijntabel_oef6c <- table(penguins$species, penguins$sex)

assocplot(Mijntabel_oef6c)
