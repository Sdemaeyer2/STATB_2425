...
#| exercise: ex2
#| check: true
answer <- leveneTest(penguins$bill_length_mm, penguins$species)
if (identical(.result, answer)) {
  list(correct = TRUE, message = "Juist!")
} else {
  list(correct = FALSE, message = "Fout.")
...
Rapporteren is van cruciaal belang. Wil je meer toelichting bij de bovenstaande rapportage, klik dan door naar [hier](ANOVA_Rapportage.qmd).
