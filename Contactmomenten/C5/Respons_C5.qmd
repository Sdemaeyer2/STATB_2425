...
$\text{TAC.naZ} = 0.45 + (-0.52 \cdot \text{Mod\_wetD}) + (-0.73 \cdot \text{OverigeD}) + (-0.23 \cdot \text{PISA\_EigenInbrengZ}) + (0.12 \cdot \text{PISA\_ExperimenterenZ})$
...
$\text{Gender.voorZ} = -0.32 + 0.58 \cdot \text{GeslachtD} + -0.07 \cdot \text{Richting2cat1} + 0.51 \cdot \text{GelachtD:Richting2cat1}$
...
$\text{Gender.voorZ} = -0.32 + 0.58 \cdot \text{GeslachtD} + 0 \cdot \text{Richting2cat1} + 0.51 \cdot \text{GelachtD:Richting2cat1}$
